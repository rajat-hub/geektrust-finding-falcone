...
/* Action Imports */
import { updatePlanetSelection } from '../../redux/actions/planetActions';
  ...
  render() {
    ...
    return (
      <div className="planetContainer">
        ...
        <VehicleSelection
          show={props.planetSelectionList[step]}
          distance={props.planetMap[props.planetSelectionList[step]]}
          step={step}
        />
      </div>
    );
